          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleFormSubmit} className="bg-white rounded-t-[40px] flex-1 min-h-screen overflow-y-scrollp p-5 w-full">
              ...
              <div className="flex-2 justify-center item-center">
                <button
                  className={`rounded-lg w-full bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline mb-4 ${
                ...
                <button type="button" className="rounded-lg w-full bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
                  <a href="/register">
                    Sign up
                  </a>
                </button>
